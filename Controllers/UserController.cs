...
namespace CRUD_application_2.Controllers
{
    public class UserController : Controller
    {
      ...
      // GET: User/Details/5
        ...
        {
            // This method is responsible for displaying the details of a specific user based on the provided ID.
        ...
        {
            // This method is responsible for displaying the view to confirm the deletion of an existing user with the specified ID.
